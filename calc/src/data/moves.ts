...
const RBY: {[name: string]: MoveData} = {
  ...
  Absorb: {bp: 50, type: 'Grass', drain: [1, 2]},
  ...
  'Spike Cannon': {bp: 25, type: 'Normal', multihit: [2, 5]},
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Needle Arm': {bp: 90, type: 'Grass', makesContact: true},
  ...
  'Shock Wave': {bp: 70, type: 'Electric'},
...
const DPP_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Dark Pulse': {bp: 90, type: 'Dark', category: 'Special'},
...
const BW_PATCH: {[name: string]: DeepPartial<MoveData>} = {
  ...
  'Fire Pledge': {bp: 100, type: 'Fire', category: 'Special'},
  'Frost Breath': {bp: 40, type: 'Ice', willCrit: true, category: 'Special'},
  'Grass Pledge': {bp: 100, type: 'Grass', category: 'Special'},
  ...
  Incinerate: {bp: 50, type: 'Fire', target: 'allAdjacentFoes', category: 'Special'},
  'Low Sweep': {
    bp: 60,
    type: 'Fighting',
    makesContact: true,
  ...
  'Water Pledge': {bp: 100, type: 'Water', category: 'Special'},
